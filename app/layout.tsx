...
export const metadata: Metadata = {
  ...
  keywords: ["auto detailing", "car detailing", "San Antonio", "IDA certified", "mobile detailing", "paint correction", "ceramic coating", "interior detailing", "Stone Oak", "Alamo Heights"],
