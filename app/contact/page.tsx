        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
              ...
              <p className="text-gray-300">
                Yes! We offer mobile car detailing services throughout the San Antonio area. We can detail your vehicle at your home, office, or any convenient location.
              </p>
            </div>
            ...
            <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
              ...
              <p className="text-gray-300">
                We accept cash, credit cards, and debit cards. Payment is due upon completion of service.
              </p>
            </div>
          </div>
        </div>
