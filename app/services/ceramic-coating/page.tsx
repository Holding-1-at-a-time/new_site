...
export const metadata: Metadata = {
  title: 'Ceramic Coating San Antonio | One Detail At A Time',
  description: 'Premium nano-ceramic coating provides 3-5 years of protection. Professional-grade application with paint correction included. Serving Alamo Heights, Stone Oak, and surrounding areas.',
  keywords: [
  ...
  openGraph: {
    title: 'Ceramic Coating | San Antonio Auto Detailing',
      ...
      <div className="min-h-screen bg-gray-950">
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
            ...
            <p className="text-2xl text-gray-300 mb-12 max-w-3xl mx-auto">
              Premium nano-ceramic coating provides 3-5 years of protection. Professional-grade application with paint correction included.
            </p>
            <div className="flex flex-wrap gap-6 items-center justify-center mb-12">
              <div className="bg-gray-800/50 px-8 py-4 rounded-xl border border-gray-700">
                ...
                <div className="text-primary font-bold text-3xl">$800</div>
              </div>
              <div className="bg-gray-800/50 px-8 py-4 rounded-xl border border-gray-700">
                <div className="text-gray-400 text-sm mb-1">Duration</div>
                <div className="text-white font-semibold text-2xl">2-3 days</div>
              </div>
            </div>
            <a
              href={`tel:${businessInfo.phone.replace(/[^\d]/g, '')}`}
        ...
        <section className="py-32">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {["Professional-grade nano-ceramic coating","3-5 year protection","Enhanced gloss and depth","Hydrophobic water beading","UV and chemical resistance","Easier maintenance","Includes paint correction"].map((feature, index) => (
        ...
        <section className="py-32 bg-gray-900/50">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {["Long-term protection perfect for San Antonio weather","Superior gloss and water beading effect","Protects against Texas UV rays and heat","Reduces washing frequency and effort significantly"].map((benefit, index) => (
        ...
        <section className="py-32">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[{"step":1,"title":"Paint Preparation","description":"Full paint correction for perfect surface"},{"step":2,"title":"Surface Prep","description":"Panel wipe removes all residues"},{"step":3,"title":"Coating Application","description":"Careful application in controlled environment"},{"step":4,"title":"Curing","description":"24-48 hour cure time before delivery"}].map((step) => (
        ...
        <section className="py-32 bg-gray-900/50">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="space-y-6">
              {[{"question":"How long does ceramic coating last in San Antonio?","answer":"Our professional ceramic coating lasts 3-5 years with proper maintenance, even in Texas heat and sun."},{"question":"What is ceramic coating cost in San Antonio?","answer":"Professional ceramic coating starts at $800 including paint correction. Serving Alamo Heights, Stone Oak, and greater San Antonio."},{"question":"Can I wash my car after ceramic coating?","answer":"Wait 7 days before first wash. After that, wash normally with pH-neutral soap. Coating makes washing much easier."}].map((faq, index) => (
        ...
        <section className="py-32 bg-gradient-to-br from-primary/10 to-primary/5 border-y border-primary/20">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-5xl font-bold mb-6">Ready for Ceramic Coating?</h2>
            <p className="text-2xl text-gray-300 mb-12 max-w-2xl mx-auto">
              Schedule your ceramic coating service in San Antonio today
            </p>
