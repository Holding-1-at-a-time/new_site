 ...
 * ServicePage
 * 
 * This page displays the details of the interior deep 
 * cleaning service offered by One Detail At A Time, LLC 
 * in San Antonio, TX. It includes a description of the 
 * service, pricing, duration, and areas served.
 */
export default function ServicePage() {
  return (
    <><>
            ...
            <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
              ...
              >
                <svg className="w-6 h-6 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 14l-7 7m0 0l-7-7m7 7V3" /> {/* This path is for the scroll-down arrow, not a phone icon */}
                </svg>
              </a></div>
          </section>

          <div className="absolute bottom-8 left-1/2 -translate-x-1/2 animate-bounce"> {/* This div is outside the section, which is causing the parsing error */}
      ...
      </section><section className="py-32">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      </section><section className="py-32 bg-gray-900/50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      </section><section className="py-32 bg-gradient-to-br from-primary/10 to-primary/5 border-y border-primary/20">
