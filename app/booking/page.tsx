 ...
 *
 * This component renders the booking page, which includes
 * a hero section with a heading, a form to schedule an
 * appointment, and a section with information about what to
 * expect during the appointment.
 *
